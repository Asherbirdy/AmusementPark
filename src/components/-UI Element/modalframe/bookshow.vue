  ...
  <modal-l>
    <article>
      ...
      <div class="showContent">
        <section
          v-for="(title, titleIndex) in showList"
          :key="titleIndex"
          class="introduce"
        >
          <h2>表演介紹</h2>
...
const propsType = ref('CrazyArtist');
const showList = ref([]);
const testArr = {
  DreamInterpretation: [
    {
